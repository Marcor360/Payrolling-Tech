...
export default function Beneficios1() {
    return (
        <>
            ...
            {/* HERO */}
            <section className="bg-fondo-cremita pt-6 md:pt-10 pb-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
                        {/* Imagen primero en mobile */}
                        <div className="lg:col-span-6">
                            <div
                                className="relative overflow-hidden rounded-2xl border border-cardeno/10 bg-blanco
                           h-[50vh] min-h-[320px]"
                            >
                             ...
                             rounded-full bg-blanco text-cardeno font-semibold px-3.5 py-2 shadow-sm
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="md:mx-auto md:max-w-4xl text-noche space-y-4">
                        <p className="text-center md:text-justify leading-relaxed">
                            En un <span className="font-semibold">entorno laboral</span> cada vez{" "}
                            <span className="font-semibold">más competitivo</span>, atraer y retener talento se ha convertido en uno
                            de los mayores desafíos para las empresas. Ya no se trata solo de llenar vacantes, sino de{" "}
                            <span className="font-semibold">construir equipos comprometidos, motivados y alineados</span> con los
                            objetivos del negocio.
                        </p>
                        <p className="text-center md:text-justify leading-relaxed">
                            En Payrolling Tech entendemos que el talento es el motor que impulsa el crecimiento. Por eso
                            desarrollamos estrategias integrales que van más allá de la contratación tradicional y abarcan todo el
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-8">
                    ...
                    <article className="lg:col-span-8 space-y-12">
                        ...
                        <section id="propuesta-valor" className="scroll-mt-24">
                            ...
                            <div className="mt-4 space-y-4 text-noche">
                                <p className="text-center md:text-justify leading-relaxed">
                                    ...
                                    quieren propósito, flexibilidad y oportunidades reales de crecimiento. Tu propuesta de valor como
                                    empleador debe reflejar quién eres como empresa y qué te hace diferente.
                                </p>

                                <ul className="list-disc pl-6 md:pl-8 space-y-2 text-center md:text-left">
                                    <li>
                                        <span className="font-semibold">Comunica tu cultura organizacional:</span> muestra lo que hace única
                                        a tu empresa.
                                    </li>
                                    <li>
                                        <span className="font-semibold">Ofrece desarrollo profesional:</span> programas de capacitación,
                                        mentorías o planes de carrera.
                                    </li>
                                    <li>
                                        <span className="font-semibold">Promueve el bienestar y la flexibilidad:</span> modelos híbridos,
                                        días personales y beneficios a la medida.
                                    </li>
                                </ul>
                        ...
                        <section id="digitaliza-reclutamiento" className="scroll-mt-24">
                            ...
                            <div className="mt-4 space-y-4 text-noche">
                                <p className="text-center md:text-justify leading-relaxed">
                                    La tecnología es un aliado fundamental en la{" "}
                                    <span className="font-semibold">búsqueda de talento</span>. Desde sistemas de seguimiento de
                                    candidatos hasta analítica avanzada, digitalizar el proceso te permite:
                                </p>

                                <ul className="list-disc pl-6 md:pl-8 space-y-2 text-center md:text-left">
                                    <li>
                                        <span className="font-semibold">Analizar métricas clave</span> como rotación o desempeño de
                                        contrataciones.
                                    </li>
                                    <li>
                                        <span className="font-semibold">Garantizar procesos más justos, ágiles y transparentes.</span>
                                    </li>
                                    <li>
                                        <span className="font-semibold">Automatizar tareas repetitivas</span> y enfocarte en la experiencia
                                        del candidato.
                                    </li>
                                </ul>

                                <p className="text-center md:text-justify leading-relaxed">
                                    Con un enfoque data-driven, logramos que el reclutamiento se convierta en una herramienta
                                    estratégica.
                                </p>
                            </div>
                        </section>
                        ...
                        <section id="retener" className="scroll-mt-24">
                            ...
                            <div className="mt-4 space-y-4 text-noche">
                                ...
                                <ul className="list-disc pl-6 md:pl-8 space-y-2 text-center md:text-left">
                                    <li>
                                        <span className="font-semibold">Diseñar planes de compensación</span> flexibles y beneficios
                                        personalizados.
                                    </li>
                                    <li>
                                        <span className="font-semibold">Fomentar la retroalimentación</span> constante y el liderazgo
                                        positivo.
                                    </li>
                                    <li>
                                        <span className="font-semibold">Medir la satisfacción</span> del personal y actuar con base en los
                                        resultados.
                                    </li>
                                </ul>

                                <p className="text-center md:text-justify leading-relaxed">
                                    Nuestro servicio de gestión de talento y nómina inteligente permite a las empresas enfocarse en su
                                    gente, mientras nosotros nos encargamos de la administración y cumplimiento.
                                </p>
                                ...
                                <p className="text-center md:text-justify leading-relaxed">
                                    ...
                                    Las empresas que invierten en su cultura, digitalización y bienestar interno son las que logran
                                    construir equipos fuertes, comprometidos y exitosos.
                                </p>
                                <p className="text-center md:text-justify leading-relaxed">
                                    En Payrolling Tech te ayudamos a lograrlo. Descubre cómo nuestras soluciones pueden impulsar tu
                                    estrategia de atracción y gestión de talento.
                                </p>
